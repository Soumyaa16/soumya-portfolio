export const skills = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "REST API", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/api/api-original.svg" },
        ],
    },
    {
        ...
        items: [
            ...
            { name: "CI/CD", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cicd/cicd-original.svg" },
